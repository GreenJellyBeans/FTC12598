...
@Autonomous(name="AOpMode_LEDMorse_A", group="Pushbot")
//@Disabled
/*
 *  This Autonomous OpMode makes the LED lights play "A" in morse code.
 */
public class AOpMode_LEDMorseA extends OpMode{
    final String THIS_COMPONENT = "AOM_LEDMorseA"; // Replace EMPTY by short word identifying Op mode
    private final RuntimeSupportInterface rt = new AndroidRuntimeSupport(this);
    final String MORSE_MESSAGE = "A";
    ...
    @Override
    public void init() {
        log = rt.startLogging(AOpMode_LEDMorseA.class.toString());
