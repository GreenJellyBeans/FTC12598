...
@Autonomous(name="AOpMode_LEDMorse_X", group="Pushbot")
//@Disabled
/*
 *  This Autonomous OpMode makes the LED lights play "X" in morse code.
 */
public class AOpMode_LEDMorseX extends OpMode{
    final String THIS_COMPONENT = "AOM_LEDMorseX"; // Replace EMPTY by short word identifying Op mode
    private final RuntimeSupportInterface rt = new AndroidRuntimeSupport(this);
    final String MORSE_MESSAGE = "X";
    ...
    @Override
    public void init() {
        log = rt.startLogging(AOpMode_LEDMorseX.class.toString());
