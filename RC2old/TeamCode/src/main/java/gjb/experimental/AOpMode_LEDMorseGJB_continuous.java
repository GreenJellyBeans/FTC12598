...
@Autonomous(name="AOpMode_LEDMorse_CONTINUOUS", group="Pushbot")
//@Disabled
/*
 *  This Autonomous OpMode makes the LED lights play "CAT" in morse code.
 */
public class AOpMode_LEDMorseGJB_continuous extends OpMode{
    ...
    @Override
    public void init() {
        log = rt.startLogging(AOpMode_LEDMorseGJB_continuous.class.toString());
