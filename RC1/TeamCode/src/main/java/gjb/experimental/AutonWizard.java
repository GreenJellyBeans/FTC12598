...
public class AutonWizard {
    ...
    static final double     JEWEL_MOVEMENT = 3.0;
    ...
    public void init() {
        ...
        rHuemanatee = rt.hwLookup().getColorSensor("RHuemanatee");
        lHuemanatee = rt.hwLookup().getColorSensor("LHuemanatee");
    ...
    public int getColor() {
        ...
        int ret = classifyColor(h, s, v);
        rt.telemetry().addData("COLOR", ret);
    ...
    void deinit() {
        // TODO: try deiniting all the sensors, including the 2 floor sensors,
        // and see which has issues.
        //this.sensorColor.close();
        //this.lHuemanatee.close();
        //this.rHuemanatee.close();
        deinitVuforia();
        //this.drive.deinit();
    }
    ...
    public static int classifyColor(double h, double s, double v) {
        int ret = UNKNOWN;
    ...
    public void encoderDrive2(double speed,
        ...
        if (rt.opModeIsActive()) {
            ...
            while (rt.opModeIsActive() &&
                    (runtime.seconds() < timeoutS) &&
                    (drive.leftDrive.isBusy() && drive.rightDrive.isBusy())&& getColor() != RED) {
