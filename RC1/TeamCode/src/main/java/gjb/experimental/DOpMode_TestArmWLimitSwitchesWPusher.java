...
@TeleOp(name="DOpMode_TestArmWLimitSwitchesWPusher", group="dummy")
//@Disabled
/*
 ...
 */
public class DOpMode_TestArmWLimitSwitchesWPusher extends OpMode{
    ...
    SubSysArmWPusher arm;
    ITask_ArmWLimitSwitchesWPusher task;
    ...
    @Override
    public void init() {
        log = rt.startLogging(DOpMode_TestArmWLimitSwitchesWPusher.class.toString());
        log.pri1(LoggingInterface.INIT_START, THIS_COMPONENT);

        arm = new SubSysArmWPusher(rt);

        // Do any additional op-mode initialization here.
        task = new ITask_ArmWLimitSwitchesWPusher(rt, arm);
