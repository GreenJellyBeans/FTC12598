...
@Autonomous(name="AOpMode_samplingCraterDepotOurCraterPath", group="Pushbot")
//@Disabled
public class AOpMode_samplingCraterDepotOurCraterPath extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        apu.samplingCraterDepotOurCraterPath();
    }
