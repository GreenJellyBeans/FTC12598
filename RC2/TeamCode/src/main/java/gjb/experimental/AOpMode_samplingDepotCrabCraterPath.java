...
@Autonomous(name="AOpMode_samplingDepotCrabCraterPath", group="Pushbot")
//@Disabled
public class AOpMode_samplingDepotCrabCraterPath extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        apu.samplingDepotCrabCraterPath();
    }
