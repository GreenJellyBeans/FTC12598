...
@Autonomous(name="AOpMode_samplingDepotOtherCraterPath", group="Pushbot")
//@Disabled
public class AOpMode_samplingDepotOtherCraterPath extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        apu.samplingDepotOtherCraterPath();
    }
