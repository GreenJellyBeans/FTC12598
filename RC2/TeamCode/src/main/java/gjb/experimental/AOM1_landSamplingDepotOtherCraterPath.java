...
@Autonomous(name="AOM1_landSamplingDepotOtherCraterPath", group="Pushbot")
@Disabled
public class AOM1_landSamplingDepotOtherCraterPath extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        apu.landSamplingDepotOtherCraterPath();
    }
