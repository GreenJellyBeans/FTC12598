...
@Autonomous(name="AOpMode_samplingCraterDepotOtherCraterPath", group="Pushbot")
//@Disabled
public class AOpMode_samplingCraterDepotOtherCraterPath extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        apu.samplingCraterDepotOtherCraterPath();
    }
