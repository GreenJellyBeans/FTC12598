...
@Autonomous(name="AOM2_landSamplingTestWSideMarker", group="Pushbot")
//@Disabled
public class AOM2_landSamplingTestWSideMarker extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        apu.landSamplingTestWSideMarker();
    }
