...
@Autonomous(name="AOpMode_LEDMorse_BEAN", group="Pushbot")
//@Disabled
/*
 *  This Autonomous OpMode makes the LED lights play "BEAN" in morse code.
 */
public class AOpMode_LEDMorseBEAN extends OpMode{
    final String THIS_COMPONENT = "AOM_LEDMorseBEAN"; // Replace EMPTY by short word identifying Op mode
    private final RuntimeSupportInterface rt = new AndroidRuntimeSupport(this);
    final String MORSE_MESSAGE = "BEAN";
    ...
    @Override
    public void init() {
        log = rt.startLogging(AOpMode_LEDMorseBEAN.class.toString());
