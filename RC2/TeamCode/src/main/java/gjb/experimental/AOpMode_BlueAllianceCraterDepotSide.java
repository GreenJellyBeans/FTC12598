...
@Autonomous(name="AOpMode_BlueAllianceCraterDepotSide", group="Pushbot")
@Disabled
public class AOpMode_BlueAllianceCraterDepotSide extends LinearOpMode {
