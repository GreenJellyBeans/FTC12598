...
public class SubSysNotSoSimpleFourMotorDrive implements SubSystemInterface {
    ...
    public void init() {
        ...
        fleftDrive.setDirection(DcMotor.Direction.FORWARD); // Set to REVERSE if using AndyMark motors
        frightDrive.setDirection(DcMotor.Direction.FORWARD);// Set to FORWARD if using AndyMark motors
